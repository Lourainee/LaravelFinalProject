...
<?php $__env->startSection('title', 'Create Task - TaskFlow'); ?>
<?php $__env->startSection('page-title', 'Create New Task'); ?>
...
unset($__errorArgs, $__bag); ?>"
                    placeholder="Describe your task..." required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="date" id="due_date" name="due_date" value="<?php echo e(old('due_date')); ?>"
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['due_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <?php if($categories->count() === 0): ?>
                    <p class="text-sm text-gray-500">No categories yet. <a href="<?php echo e(route('categories.create')); ?>" class="text-blue-600 hover:underline">Create one</a></p>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\LaravelFinalProject\resources\views/tasks/create.blade.php ENDPATH**/ ?>