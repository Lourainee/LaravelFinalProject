...
return [
    ...
    | and used as needed per your application's needs.
    |
    */
    ...
    | and configure the transports, as needed by the application.
    |
    */
    ...
    */
    ...
    | message views. Or, you may simply stick with the Laravel defaults!
    |
    */
